...
- (void)viewDidLoad {
    ...
    fetchRequest.propertiesToFetch = @[@"tripId"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Set up the cell...
    NSDictionary *location = [trips objectAtIndex:indexPath.row];
    cell.textLabel.text = [NSString stringWithFormat:@"Trip %@", location[@"tripId"]];
